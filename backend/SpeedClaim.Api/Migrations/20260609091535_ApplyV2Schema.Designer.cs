...
namespace SpeedClaim.Api.Migrations
{
    ...
    [Migration("20260609091535_ApplyV2Schema")]
    partial class ApplyV2Schema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpeedClaim.Api.Models.HealthPolicyDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("PK_health_policy_details");

                    b.HasIndex("PolicyId")
                        .IsUnique();

                    b.ToTable("health_policy_details");
                });
            ...
            modelBuilder.Entity("SpeedClaim.Api.Models.LifePolicyDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("PK_life_policy_details");

                    b.HasIndex("PolicyId")
                        .IsUnique();

                    b.ToTable("life_policy_details");
                });
            ...
            modelBuilder.Entity("SpeedClaim.Api.Models.MotorPolicyDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("PK_motor_policy_details");

                    b.HasIndex("PolicyId")
                        .IsUnique();

                    b.ToTable("motor_policy_details");
                });
            ...
            modelBuilder.Entity("SpeedClaim.Api.Models.Claim", b =>
                {
                    ...
                    b.HasOne("SpeedClaim.Api.Models.User", "Surveyor")
                        .WithMany()
            ...
            modelBuilder.Entity("SpeedClaim.Api.Models.HealthPolicyDetail", b =>
                {
                    b.HasOne("SpeedClaim.Api.Models.Policy", "Policy")
                        .WithOne("HealthDetail")
                        .HasForeignKey("SpeedClaim.Api.Models.HealthPolicyDetail", "PolicyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_health_policy_details_policies");
            ...
            modelBuilder.Entity("SpeedClaim.Api.Models.LifePolicyDetail", b =>
                {
                    b.HasOne("SpeedClaim.Api.Models.Policy", "Policy")
                        .WithOne("LifeDetail")
                        .HasForeignKey("SpeedClaim.Api.Models.LifePolicyDetail", "PolicyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_life_policy_details_policies");
            ...
            modelBuilder.Entity("SpeedClaim.Api.Models.MotorPolicyDetail", b =>
                {
                    b.HasOne("SpeedClaim.Api.Models.Policy", "Policy")
                        .WithOne("MotorDetail")
                        .HasForeignKey("SpeedClaim.Api.Models.MotorPolicyDetail", "PolicyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_motor_policy_details_policies");

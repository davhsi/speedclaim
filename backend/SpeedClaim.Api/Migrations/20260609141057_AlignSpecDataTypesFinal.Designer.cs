...
namespace SpeedClaim.Api.Migrations
{
    ...
    [Migration("20260609141057_AlignSpecDataTypesFinal")]
    partial class AlignSpecDataTypesFinal
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SpeedClaim.Api.Models.Policy", b =>
                {
                    ...
                    b.HasOne("SpeedClaim.Api.Models.User", "IssuedBy")
                        .WithMany()
                        .HasForeignKey("IssuedById")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_policies_users_issued_by");

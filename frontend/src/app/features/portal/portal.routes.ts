...
export const portalRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'proposals/new',
        loadComponent: () => import('./proposals/proposal-submit/proposal-submit').then(m => m.ProposalSubmitComponent),
      ...
      { path: 'policies/:id/guide', loadComponent: () => import('./policies/policy-guide/policy-guide').then(m => m.PolicyGuideComponent) },
      ...
      {
        path: 'claims/new',
        loadComponent: () => import('./claims/claim-file/claim-file').then(m => m.ClaimFileComponent),
        canDeactivate: [unsavedChangesGuard],
      },
      ...
      {
        path: 'kyc',
        loadComponent: () => import('./kyc/kyc').then(m => m.KycComponent),
        canDeactivate: [unsavedChangesGuard],
      },
